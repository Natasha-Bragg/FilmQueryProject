...
public class Film {
	...
	public Film(int id, String title, String description, Integer release_year, String language_id, int rental_duration,
			double rental_rate, Integer length, double replacement_cost, String rating, String special_features, List<Actor> actors) {
	...
	public char[] displayFilm() {
		// TODO Auto-generated method stub
		return null;
	}
	
	public String toString() {
	return "\u2022 The film with the id number " + id + " is " + title + ", " + "and was released in " + release_year
	+ " \n\u2022 The films language was shot in " + language_id + "\n\u2022 Rating: " + rating
	+ "\n\u2022 Actors: " + actors;
